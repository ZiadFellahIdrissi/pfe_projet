                ...
                <?php
                    if (strpos($fullurl, "name")) { ?>
                        <div class="toast-body">
                            <strong>Module</strong> déjà existe.
                        </div>
                <?php
                    }
                ?>
    ...
    ?>
        <div aria-live="polite" aria-atomic="false" style="position: absolute; top: 13%; right: 3%;  min-height: 200px; ">
            <div class="toast" style=" width:700px; background-color:#55efc4;">
                ...
                <div class="toast-body">
                    <strong>Module</strong> ajouté avec succès.
                </div>
            </div>
        </div>
    ...
    ?>
        <div aria-live="polite" aria-atomic="false" style="position: absolute; top: 13%; right: 3%;  min-height: 200px; ">
            <div class="toast" style=" width:700px; background-color:#55efc4;">
                ...
                <div class="toast-body">
                    <strong>Module</strong> supprimé avec succès.
                </div>
            </div>
        </div>
    <?php
    ...
    ?>
        <div aria-live="polite" aria-atomic="false" style="position: absolute; top: 13%; right: 3%;  min-height: 200px; ">
            <div class="toast" style=" width:700px; background-color:#55efc4;">
                ...
                <div class="toast-body">
                    <strong>Module</strong> modifié avec succès.
                </div>
            </div>
        </div>
    <?php
    ...
    ?>
        <div aria-live="polite" aria-atomic="false" style="position: absolute; top: 13%; right: 3%;  min-height: 200px; ">
            <div class="toast" style=" width:700px; background-color:#55efc4;">
                ...
                <div class="toast-body">
                    <strong>Module</strong> activé avec succès.
                </div>
            </div>
        </div>
    <?php
