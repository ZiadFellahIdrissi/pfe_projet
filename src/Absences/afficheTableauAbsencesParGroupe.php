                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <th>
                                <a href="supprimer_absences.php?id_absence=<?php echo $row['id_absence'] ?>">
                                    <img width=20 heigth=20 src="https://bit.ly/2UwQb08">
                                </a>
                            <td>
                                <input type="button" data-info="<?php echo $row['id_absence'] ?>"  value="Modifie" class="btn btn-info btn-xs open_modifierabsence">
                            </td>
                            </th>
                        </tr>
            <?php
